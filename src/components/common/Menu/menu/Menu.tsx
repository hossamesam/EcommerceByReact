...
import { ContactRoundIcon, LayoutDashboard, Package, PanelsLeftBottom } from 'lucide-react';

const { burger, sidenav, xx, mySidenav, bgside } = style
